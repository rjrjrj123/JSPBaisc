...
<%
	...
	2. id가 abc123이고 비밀번호가 asd123이라면 로그인 성공으로 간주하고 res_ex02_welcome 리다이렉트
	   ...
	   id가 틀린경우는 res_ex02_idfail 로 리다이렉트
	   pw가 틀린경우는 res_ex02_pwfail 로 리다이렉트
	...
	*/
	...
	if( id.equals("abc123") && pw.equals("asd123") ) { //로그인 성공
		response.sendRedirect("res_ex02_welcome.jsp");
	
	} else if( !id.equals("abc123") ) { //id틀린경우
		response.sendRedirect("res_ex02_idfail.jsp");
		
	} else if( !pw.equals("asd123") ) { //pw틀린경우
